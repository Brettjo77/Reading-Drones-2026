...
const CSPAGES2 = (() => {
  ...
  const PROJECTS = [
    ...
    { id: 'traitors-castle', cat: 'editorial', t: "Ardross Castle — 'The Traitors'", sub: 'Editorial · BBC location · Stills', y: '2025', tone: 'estate', img: '/assets/photos/traitors-castle.jpg',
      excerpt: "Aerial stills of Ardross Castle in the Highlands — the location used by the BBC for The Traitors. Personal editorial work on a clear-day pass." },
