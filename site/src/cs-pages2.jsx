...
const CSPAGES2 = (() => {
  ...
  const PROJECTS = [
    ...
    { id: 'wokingham', cat: 'inspection', t: 'Wokingham House', sub: 'Roof + chimney inspection', y: '2025', tone: 'rooftop', img: '/assets/photos/ouse-viaduct-arches.jpg',
      excerpt: 'High-resolution photo report — 32 annotated images, delivered as PDF the same day.' },
    { id: 'sonning', cat: 'aerial', t: 'Sonning Estate Aerials', sub: 'Editorial · Brochure', y: '2025', tone: 'fields', img: '/assets/photos/shinfield-tree-sunset.jpg',
      excerpt: 'Wide-format estate aerials shot in three sessions across spring, summer and autumn light.' },
    { id: 'bracknell', cat: 'event', t: 'Bracknell FC Match-day', sub: 'Sports · Highlights reel', y: '2024', tone: 'sport', img: '/assets/photos/shinfield-sports-fields.jpg',
      excerpt: 'CAA-cleared low-altitude crowd shots and aerial coverage of the Bracknell vs Maidenhead derby.' },
    { id: 'reading-uni', cat: 'event', t: 'University Open Day', sub: 'Events · Day-of-edit', y: '2024', tone: 'venue', img: '/assets/photos/shinfield-tennis-courts.jpg',
